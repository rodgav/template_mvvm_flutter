...
class ForgPassConfUseCase
    implements BaseUseCase<TestRequest, Test> {
  final Repository _repository;

  ForgPassConfUseCase(this._repository);

  @override
  Future<Either<Failure, Test>> execute(TestRequest input) async {
    return await _repository.forgotPasswordConfirmation(input);
  }
}
